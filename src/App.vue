  ...
  <div class='title-wrapper'>
    <div class='title-sticky'>
      ...
      <div class='maintitle'>
        ...
        <h3 class='subheading'>Designer and developer creating human-centered data experiences with genuine curiosity.</h3>
        <br>
      </div>
      ...
      <div class='aboutme'>
        ...
        <div class='aboutme-text'>
          <p>
            I am a full-time data analyst based in Brooklyn, NY and a M.S. candidate in Data Analysis & Visualization at the CUNY Graduate Center. I like obsessing over details, watching video essays, and going for long walks in the cemetery near my home.
            <br>
            <br>
            I have experience in Tableau, D3, Vue, and Python, but I'm down to use (and learn) any tool that’s right for the job. Check out my work and connect with me! 
          </p>
          <br>
          <br>
        </div>
        ...
        <div class='contactme-content'>
          ...
          <div class='icon-wrapper'>
            <div class='contact-icon'>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 15">
